<?php
/*
 * Template Name: Single Directory Listing New
 */
get_header();
...
<body>
    <div class="page-wrapper">
                    ...
                    <div class="key-info-item">
                        ...
                        <div>
                            ...
                            <div class="open-status">
                                <?php 
                                $current_status = get_current_business_hours($business_hours);
                                if ($current_status && isset($current_status['is_open'])) :
                                    if ($current_status['is_open']) : ?>
                                        <span class="status-badge open">
                                            <i class="fas fa-circle"></i> Currently Open
                                        </span>
                                        <?php if (isset($current_status['closes'])) : ?>
                                            <span class="next-hours">Closes at <?php echo esc_html($current_status['closes']); ?></span>
                                        <?php endif; ?>
                                    <?php else : ?>
                                        <span class="status-badge closed">
                                            <i class="fas fa-circle"></i> Currently Closed
                                        </span>
                                        <?php if (isset($current_status['next_open'])) : ?>
                                            <span class="next-hours">Opens <?php echo esc_html($current_status['next_open']); ?></span>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </div>
                ...
                <div class="about-content">
                    ...
                    <?php if ($service_area) : ?>
                        <div class="service-area-content">
                            <h3>Service Area</h3>
                            <?php 
                            if (is_array($service_area) && isset($service_area['areas'])) {
                                $areas = explode(',', $service_area['areas']);
                                echo '<p>' . esc_html(implode(', ', array_map('trim', $areas))) . '</p>';
                            } elseif (is_string($service_area)) {
                                echo '<p>' . esc_html($service_area) . '</p>';
                            }
                            ?>
                        </div>
                    <?php endif; ?>
        ...
        <aside class="sidebar">
            ...
            <!-- Related Businesses -->
            <?php
            $related_businesses = get_related_businesses(get_the_ID(), 3);
                ...
                <ul class="related-listings">
                    ...
                    ?>
                        <li class="related-listing-item">
                            <h4 class="related-listing-title">
            ...
            ?>
            <div class="sidebar-widget listing-management <?php echo $listing_claimed ? 'claimed' : 'unclaimed'; ?>">
                <?php if (!$listing_claimed) : ?>
                    ...
                    <a href="<?php echo esc_url(add_query_arg('claim', get_the_ID(), home_url('/claim-listing/'))); ?>" 
                    ...
                    if ($owner) : ?>
                        <div class="owner-info">
                            ...
                            <div class="owner-details">
                                ...
                                <span class="owner-role">Business Owner</span>
                            </div>
                        </div>
                    <?php endif; ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const setupVoting = () => {
            ...
            const handleVote = async (type) => {
                ...
                const nonce = '<?php echo wp_create_nonce("vote_nonce"); ?>';
                try {
                    const response = await fetch('<?php echo admin_url("admin-ajax.php"); ?>', {
                        ...
                        body: new URLSearchParams({
                            action: 'handle_vote',
                            nonce: nonce,
                            post_id: upvoteBtn.dataset.postId,
                            vote_type: type
                        })
                    });
                    ...
                    const data = await response.json();
                    if (data.success) {
                        voteCount.textContent = data.data.new_count;
                        upvoteBtn.disabled = true;
                        downvoteBtn.disabled = true;
                    } else {
                        throw new Error(data.data.message || 'Vote failed');
                    }
                } catch (error) {
        ...
        const setupQuickContactForm = () => {
            ...
            form.addEventListener('submit', async (e) => {
                ...
                formData.append('action', 'submit_quick_contact');
                ...
                try {
                    ...
                    if (data.success) {
                        ...
                        throw new Error(data.data.message || 'Message sending failed');
                    }
                } catch (error) {
