<?php
/*
Template Name: Free Restaurant Listing Form
*/
...
<div class="directory-listing-form-container">
    ...
    <div class="hero-section">
        ...
        <div class="hero-content">
            <h1 class="hero-title">Add Your Free Restaurant Listing</h1>
            <p class="hero-text"></p>
        </div>
    </div>
    ...
    <div class="form-container">
        <form id="directory-listing-form" method="post" data-form-type="free-restaurant" enctype="multipart/form-data">
            ...
            <div class="form-section active" data-step="1">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-field">
                        ...
                        <span class="field-hint">For account verification</span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section" data-step="2">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-field">
                        ...
                        <span class="field-hint">Link to your online menu (if available)</span>
                    </div>
